			...
			<div className="w-full md:w-1/3 text-left">
				...
				>
					<a
						...
						className="font-general-medium flex justify-center items-center w-24 sm:w-48 mt-12 mb-7 sm:mb-0 text-lg py-2.5 sm:py-3 shadow-lg rounded-lg bg-indigo-500 focus:ring-1 hover:bg-indigo-600 text-gray-100 hover:text-white duration-500 p-2"
